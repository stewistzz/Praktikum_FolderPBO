...
public class Pelanggan {
    ...
    public void permintaanRental(LocalDate tanggalRental, int idRental, String jenisPS, int jumlah, PegawaiRental pegawai) {
        // object
        RentalPS rental = new RentalPS(idRental, jenisPS, jumlah, pegawai, tanggalRental);
